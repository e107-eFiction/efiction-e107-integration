...
$query = "INSERT INTO `#fanfiction_blocks` (`block_name`, `block_title`, `block_file`, `block_status`, `block_variables`) 
VALUES('poll', 'Poll', '0', 'poll/poll.php', '')";
e107::getDB()->gen($query);	
 
$query = "CREATE TABLE IF NOT EXISTS `#fanfiction_poll_votes` (
...
$query = "CREATE TABLE IF NOT EXISTS `#fanfiction_poll` (
