    ...
    class efiction_comments
{
	...
	function __construct()
	{
		...
		{		
			...
			$COMMENT_TEMPLATE =  e107::getTemplate('efiction', 'comment');
		}
	...
	// 	require_once(e_HANDLER."ren_help.php");
		...
		//	$text .= "Indent = ".$indent;
            ...
            $sc = e107::getScParser()->getScObject('comment_shortcodes', 'efiction', false);
...
//		$ns = new e107table;
		...
		$comment_shortcodes = e107::getScParser()->getScObject('comment_shortcodes', 'efiction', false);
...
// ------------- TODO move the 'listing' into separate function so that ajax can access it easily. 
	...
	function nextprev($table,$id,$from=0)
	{
		...
		{
			$prev = _BASEDIR . 'reviews.php?mode=list&amp;type=' . $table . '&amp;id=' . $id . '&amp;from=0';
			$next = _BASEDIR . 'reviews.php?mode=list&amp;type=' . $table . '&amp;id=' . $id . '&amp;from=0';
